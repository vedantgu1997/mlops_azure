...
from imgSegmentation.components.data_ingestion import DataIngestion
from imgSegmentation.entity.config_entity import DataIngestionConfig
from imgSegmentation.entity.artifacts_entity import DataIngestionArtifact
